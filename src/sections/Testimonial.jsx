...
const ReviewCard = ({ img, description, title, body }) => {
  return (
    <figure
      className={twMerge(
...
export default function Testimonial() {
  ...
  return (
    <div className="items-start mt-25 md:mt-35 c-space">
      <h2 className="text-heading text-center">{t('testimonial.how')}</h2>
      ...
      <h2 className="text-heading mt-12">{t('testimonial.process')}</h2>
      <br />
